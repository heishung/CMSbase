        ...
        <div class="tab-content" style="margin-top: 20px">
            ...
            <div class="tab-pane" id="social_info">
                ...
                <form class="col-md-6" action="{{route('admin.settings.info', ['key' => 'socialInfo'])}}" method="POST">
                    ...
                    <div class="form-group">
                        <label>Github</label>
                        <input value="{{$socialInfo->github or ''}}" class="form-control" type="text" name="github">
                    </div>
                    <div class="form-group">
                        <label>Google+</label>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$socialInfo->tele or ''}}" class="form-control" type="text" name="telegram">
                    </div>
                    <div class="form-group">
                        <label>Youtube</label>
                    ...
                    <div class="form-group">
                        <label>video Youtube in site</label>
                        <input value="{{$socialInfo->youtubeinsite or ''}}" class="form-control" type="text" name="youtubeinsite">
                    </div>
                    <div class="form-group">
                        <label>Twitter</label>
